...
for trajectory in range(1):
    ...
    for episode in range(episode_max):
        ...
        while not is_terminal_state(current_state, n_jobs):
            ...
            obj_cur = objective_value_reward(current_state)
            reward = 1 / obj_cur
        ...
        ep_rewards100.append(1 / current_state_obj)

    print(best_sol_obj, round(time.time() - start_time))
...
#             best_sol_prm = current_state
#         #ep_rewards.append(episode_reward)
#         ep_rewards1000.append(1 / current_state_obj)
#
#     print(best_sol_obj, round(time.time() - start_time))
#
# episode_max = 5000
...
#             best_sol_prm = current_state
#         #ep_rewards.append(episode_reward)
#         ep_rewards10000.append(1 / current_state_obj)
#
#     print(best_sol_obj, round(time.time() - start_time))
#
...
# length_100 = len(ep_rewards100)
# length_1000 = len(ep_rewards1000)
# length_10000 = len(ep_rewards10000)
#
# plt.plot(list(range(0, length_100))[::2], ep_rewards100[::2], color='r', label='epsilon = 0.9', linewidth=0.5)
# plt.plot(list(range(length_100, length_100 + length_1000))[::2], ep_rewards1000[::2], color='g', label='epsilon = 0.99', linewidth=0.5)
# plt.plot(list(range(length_100 + length_1000, length_100 + length_1000 + length_10000))[::2], ep_rewards10000[::2], color='b', label='epsilon = 0.7', linewidth=0.5)
# plt.legend()
# plt.show()

with open("QLearningResults_V1_50000.txt", "w") as f:
    for s in ep_rewards100:
        f.write(str(s) +"\n")
