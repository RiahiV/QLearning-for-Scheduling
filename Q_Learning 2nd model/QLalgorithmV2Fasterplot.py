...
for trajectory in range(1):
    ...
    for episode in range(episode_max):
        ...
        ep_rewards1.append(1 / current_state_obj)
...
#         # end of this episode
#         #print("episode_reward", episode_reward)
#         ep_rewards2.append(1 / current_state_obj)
#
#     print("best_sol_obj", best_sol_obj, round(time.time() - start_time, 2))
#
# # Third scenario
...
#         # end of this episode
#         #print("episode_reward", episode_reward)
#         ep_rewards3.append(1 / current_state_obj)
#
#     print("best_sol_obj", best_sol_obj, round(time.time() - start_time, 2))
#
...
#
# length_100 = len(ep_rewards1)
# length_1000 = len(ep_rewards2)
# length_10000 = len(ep_rewards3)
#
# plt.plot(list(range(0, length_100))[::2], ep_rewards1[::2], color='r', label='discount_factor = 0.9 - learning_rate = 0.9', linewidth=0.5)
# plt.plot(list(range(length_100, length_100 + length_1000))[::2], ep_rewards2[::2], color='g', label='discount_factor = 0.9 - learning_rate = 0.1', linewidth=0.5)
# plt.plot(list(range(length_100 + length_1000, length_100 + length_1000 + length_10000))[::2], ep_rewards3[::2], color='b', label='discount_factor = 0.1 - learning_rate = 0.9',
#          linewidth=0.5)
# plt.legend()
# plt.show()


with open("QLearningResults_V2_50000.txt", "w") as f:
    for s in ep_rewards1:
        f.write(str(s) +"\n")
