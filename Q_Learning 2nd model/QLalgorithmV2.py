...
def update_q_value(q_values_table, reward, learning_rate, discount_factor, state_index, picked_action, best_Q_next_state):
    #print(q_values_table[state_index][picked_action])
    ...
    #print(best_Q_next_state, q_values_table[state_index][picked_action])
...
for trajectory in range(5):
    ...
    print("total different solutions", len(q_values_state_table))
